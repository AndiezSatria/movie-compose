package org.andiez.core.local.pref
...
/**
 *  Created by AndiezSatria on 13/03/2023
 */
...
//                    .where(object : TypeParameter<T>() {}, classType)
//                    .type
//                )
//            } else {
//                emptyList()
...
//    }
    ...
    companion object {
        ...
        fun instance(): BasePreference? {
            if (instance == null) {
                validateInitialization()
                synchronized(BasePreference::class.java) {
                    if (instance == null) {
                        instance = BasePreference()
                    }
                }
            }
            return instance
        ...
        private fun validateInitialization() {
            if (mSharedPreferences == null)
                throw BaseException("SuitSave Library must be initialized inside your application class by calling SuitSave.init(getApplicationContext)")
        }
    }
